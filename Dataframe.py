...
class Dataframe:
    ...
    def compute_band_matrix(self,dim_finale = 1000, nome_file_item = None, num_sensibile = 1,plot = True):
        ...
        if original_dataset is not None and nome_file_item is not None and len(original_dataset) >= dim_finale and len(original_dataset.columns) >= dim_finale:
        ...
        elif original_dataset is not None and nome_file_item is not None and len(original_dataset) >= dim_finale:
